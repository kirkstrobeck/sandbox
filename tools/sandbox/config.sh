...
export SANDBOX_PROJECT SANDBOX_STACK SANDBOX_PORTS SANDBOX_VOLUME_DIRS \
  ...
  SANDBOX_DEFAULT_AGENT SANDBOX_NODE_IMAGE SANDBOX_DOCKER_CLI_VERSION \
  SANDBOX_PNPM_VERSION SANDBOX_CODEX_VERSION SANDBOX_WITH_PLAYWRIGHT \
  SANDBOX_PLAYWRIGHT_VERSION SANDBOX_UPDATE_CHECK SANDBOX_IMAGE SANDBOX_STACK_LABEL
